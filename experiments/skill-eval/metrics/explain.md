...
Mỗi tiêu chí 0/1/2. Chuẩn gốc: `explain/SKILL.md` (mức + chế độ) và `explain/rule/principles.md` (cách nói). Rubric chỉ biến hợp đồng đó thành thước đo được — không thêm tiêu chuẩn mới.
